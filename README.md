...
### UPD: November 09 2024 Version 1.5
Доступно использование скрипта для скачивания видео с таких сервисов как: vk.com, rutube.ru, youtube.com и etc.  Проверялось пользователями, подробнее [можно почитать в обсуждении](https://github.com/blyamur/VK-Video-Download/issues/2)
